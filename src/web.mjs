...
const server=http.createServer((req,res)=>{
  try {
    ...
    const controlBlock=task?`<div class="control"><b>Current surface:</b> ${escape(currentSurface(task,transport))}<br/><b>Required human action:</b> ${escape(requiredHumanAction(task,transport))}</div>`:'';
